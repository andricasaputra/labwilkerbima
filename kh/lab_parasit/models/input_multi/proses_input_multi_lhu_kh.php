...
$sql = $conn->query("SELECT no_sertifikat,no_agenda FROM input_permohonan_kh_lab_parasit WHERE no_sertifikat IS NOT NULL AND no_agenda IS NULL");
...
$objectDataParasit->edit("UPDATE input_permohonan_kh_lab_parasit SET  no_agenda='$no_agenda', no_lhu='$no_lhu', tanggal_lhu='$tanggal_lhu', kepala_plh2='$kepala_plh2', nip_kepala_plh2='$nip_kepala_plh2' WHERE id ='$id'");
