...
$sql = $conn->query("SELECT kode_sampel,mt FROM input_permohonan_kh_lab_parasit WHERE kode_sampel IS NOT NULL AND mt IS NULL");
...
if ($cek == 0) {
 ...
 if($mt !=="") {
	 ...
	 $objectDataParasit->edit("UPDATE input_permohonan_kh_lab_parasit SET kondisi_sampel='$kondisi_sampel', mt='$mt', nip_mt='$nip_mt', penyelia='$penyelia', penyelia2='$penyelia2', analis='$analis',  analis2='$analis2' , bahan='$bahan', bahan2='$bahan2', alat='$alat', alat2='$alat2', kesiapan='$kesiapan' WHERE kode_sampel IS NOT NULL AND mt IS NULL");
