...
$getKode = $objectDataParasit->infoPenyerahanSampel("select");

$lastData = $objectDataParasit->infoPenyerahanSampel("1");
...
$(document).ready(function(e){
  ...
  $("#form_input_multi_penyerahan_sampel_pengujian_kh").on("submit", (function(e){
       ...
       $.ajax({
         ...
         url :'lab_parasit/models/input_multi/proses_input_multi_penyerahan_sampel_kh.php',
