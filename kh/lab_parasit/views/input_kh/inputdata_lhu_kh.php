                  ...
                  <div id="responsive-form" class="clearfix"> 
                    ...
                    <div class="column-full">
                     ...
                     <div class="column-half">
                        ...
                        <input type="text" class="form-control" name="no_agenda" id="no_agenda_input" value="<?=$no_sertifikat;?>/KH/<?=$thn?>" required>
  ...
  $(document).ready(function(e){
    ...
    $("#form_input_lhu").on("submit", (function(e){
         ...
         $.ajax({
           ...
           url :'lab_parasit/models/proses_input_lhu_kh.php',
           ...
           success : function(response){
              ...
              if (response == 'false') {
                  ...
                  $('#tb_lhu_kh_lab_parasit').DataTable().ajax.reload(null, false),
