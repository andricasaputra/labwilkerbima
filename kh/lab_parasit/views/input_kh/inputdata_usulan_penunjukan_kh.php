          ...
          <div class="column-half">
            ...
            <input type="text" class="form-control" name="nama_sampel" id="nama_sampel_input" value="<?=$nama_sampel?>" disabled>
              ...
              <?php 
                            ...
                            $setno = $objectNomorParasit->set_maxno();
                            ...
                            if (!empty($isi)) {
                                ...
                                $maxNo = $objectNomorParasit->max_no($hasil);
                                ...
                                $maxnomor = $objectNomorParasit->max_nomor($isiNo);
  ...
  $(document).ready(function(e){
    ...
    $("#form_input_penyelia_analis_kh").on("submit", (function(e){
         ...
         $.ajax({
           ...
           url :'lab_parasit/models/proses_input_penunjukan_penyelia_analis_kh.php',
