...
<div>
  ...
  <ol class="page-header breadcrumb breadcrumb-fixed">
        ...
        <div class="btn-group " align="left">
          ...
          <button type="button" class="btn btn-kuprimary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-th-list fa-fw"></i> Menu <i class="fa fa-caret-down fa-fw"></i></button>
            ...
            <div class="dropdown-menu" style="font-size: 11pt; width: 200px;">
                  ...
                  <a href="./lab_parasit/report/export/export_excel_penyerahan_sampel.php" target="_blank"><font color="#2e2e1f"><i class="fa fa-download fa-fw"></i> Export Excel Semua Data</font></a>
                ...
                <li class="divider"></li>
                    ...
                    <a href="?lab=bakteri&page=penyerahan_sampel"><font color="#2e2e1f"><i class="fa fa-arrow-circle-left fa-fw"></i> Ke Lab Bakteri</font></a>
    ...
    <div class="judul">
        ...
        <b><h4>Penyerahan Sampel Pengujian <i>(Laboratorium Parasitologi)</i></h4></b>
...
<div class="row" id="sortir">
    ...
    <div class="col-md-1" id="clear" style="margin-top: -6px; margin-left: -20px; z-index: 1">
        <button name="search" id="search_penyerahan_sampel_kh" class="btn btn-kuprimary"><i class="fa fa-sort"></i> Sortir</button>
    </div>
</div>
...
<div class="col-lg-12">
  ...
  <div class="table-responsive">
    ...
    <table class="table table-hover table-striped" id="tb_penyerahan_sampel_kh_lab_parasit" width="100%"  style="text-align: center">
        ...
        <thead>
          ...
          <tr>
              ...
              <th width= "15%">Tanggal Penyerahan Ke Lab</th>
...
<!-- Input Data -->
        ...
        <div class="modal fade" id="modal_input_penyerahan_sampel_kh" role="dialog">
            <div class="modal-dialog">
                <div id="content-data_input_penyerahan_sampel_kh"></div>
            </div>
        </div>

<!-- Input Data Multiple-->

        <div class="modal fade" id="modal_input_multi_penyerahan_sampel_kh" role="dialog">
            <div class="modal-dialog">
                <div id="content-data_input_multi_penyerahan_sampel_kh"></div>
            </div>
        </div>
...
<!-- Edit Data -->
        ...
        <div class="modal fade" id="modal_edit_penyerahan_sampel_kh" role="dialog">
            <div class="modal-dialog">
                <div id="content-data_edit_penyerahan_sampel_kh"></div>
            </div>
        </div>
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_parasit/report/print/print_penyerahansampel_multi.php" method="post" target="_blank">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_parasit/report/export/export_excel_penyerahansampel_bulan.php" method="post" target="_blank">
...
<div class="modal-dialog1">
   ...
   <div class="modal-body">
      ...
      <a class="btn btn-info btn-kembali" data-dismiss="modal"><i class="fa fa-arrow-circle-left fa-fw" aria-hidden="true"></i>Kembali</a>
                  ...
                  <table class="table1  table-hover" id="datapenyerahan_sampel_kh_lab_parasit" cellspacing="0" width="100%">
