...
<div>
    ...
    <ol class="page-header breadcrumb breadcrumb-fixed">
          ...
          <div class="btn-group " align="left">
            ...
            <button type="button" class="btn btn-kuprimary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-th-list fa-fw"></i> Menu <i class="fa fa-caret-down fa-fw"></i></button>
              ...
              <div class="dropdown-menu" style="font-size: 11pt; width: 200px;">
                   ...
                   <a href="./lab_parasit/report/export/export_excel_data_teknis.php" target="_blank"><font color="#2e2e1f"><i class="fa fa-download fa-fw"></i> Export Excel Semua Data</font></a>
                  ...
                  <a href="?lab=bakteri&page=data_teknis"><font color="#2e2e1f"><i class="fa fa-arrow-circle-left fa-fw"></i> Ke Lab Bakteri</font></a>
        ...
        <div class="judul">
            ...
            <b><h4>Data Teknis Pengujian <i>(Laboratorium Parasitologi)</i></h4></b>
 ...
 <div class="row" id="tb">
  ...
  <div class="col-lg-12">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-hover table-striped" id="tb_data_teknis_kh_lab_parasit"  width="100%"style="table-layout: fixed; width: 100%">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_parasit/report/print/print_data_teknis_multi.php" method="post" target="_blank">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_parasit/report/print/print_data_teknis_perhari.php" method="post" target="_blank">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_parasit/report/export/export_excel_data_teknis_bulan.php" method="post" target="_blank">
...
<div class="modal-dialog1">
   ...
   <div class="modal-body">
      ...
      <a class="btn btn-info btn-kembali" data-dismiss="modal"><i class="fa fa-arrow-circle-left fa-fw" aria-hidden="true"></i>Kembali</a>
                  ...
                  <table class="table1 table-bordered table-hover" id="datateknis_kh_lab_parasit" cellspacing="0" width="100%">
