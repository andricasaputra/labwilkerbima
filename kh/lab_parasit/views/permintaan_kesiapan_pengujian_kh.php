...
<div>
    ...
    <ol class="page-header breadcrumb breadcrumb-fixed">
          ...
          <div class="btn-group " align="left">
            ...
            <button type="button" class="btn btn-kuprimary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-th-list fa-fw"></i> Menu <i class="fa fa-caret-down fa-fw"></i></button>
              ...
              <div class="dropdown-menu" style="font-size: 11pt; width: 200px;">
                    ...
                    <a href="./lab_parasit/report/export/export_excel_permintaan_kesiapan_pengujian.php" target="_blank"><font color="#2e2e1f"><i class="fa fa-download fa-fw"></i> Export Excel Semua Data</font></a>
                  ...
                  <li class="divider"></li>
                    ...
                    <a href="?lab=bakteri&page=permintaan_kesiapan_pengujian"><font color="#2e2e1f"><i class="fa fa-arrow-circle-left fa-fw"></i> Ke Lab Bakteri</font></a>
      ...
      <div class="judul">
          ...
          <i class="fa fa-info-circle fa-fw fa-lg" aria-hidden="true"></i><b><h4>Data Permintaan Kesiapan Pengujian <i>(Laboratorium Parasitologi)</i></h4></b>
...
<div class="row" id="tb">
  ...
  <div class="col-lg-12">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-hover table-striped" id="tb_permintaan_kesiapan_kh_lab_parasit" width="100%"  style="text-align: center">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_parasit/report/print/print_permin_pengujian_multi.php" method="post" target="_blank">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_parasit/report/export/export_excel_permintaan_kesiapan_pengujian_bulan.php" method="post" target="_blank">
  ...
  <div class="modal-dialog1">
     ...
     <div class="modal-body">
        ...
        <a class="btn btn-info btn-kembali" data-dismiss="modal"><i class="fa fa-arrow-circle-left fa-fw" aria-hidden="true"></i>Kembali</a>
                    ...
                    <table class="table1 table-hover" id="dataperminkesiapan_kh_lab_parasit" cellspacing="0" width="100%">
