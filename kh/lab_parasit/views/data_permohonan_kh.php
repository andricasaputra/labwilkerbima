...
<div>
	...
	<ol class="page-header breadcrumb breadcrumb-fixed">
		...
		<div id="top">
			...
			<button type="button" class="btn btn-kuprimary" data-toggle="modal" id="tombol_input_permohonan_kh"><i class="fa fa-plus-circle fa-fw"></i>Data Baru</button>
			...
			<div class="btn-group " align="left">
			  ...
			  <button type="button" class="btn btn-kuprimary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-th-list fa-fw"></i> Menu <i class="fa fa-caret-down fa-fw"></i></button>
				  ...
				  <div class="dropdown-menu" style="font-size: 11pt; width: 200px;">
				    ...
				    <a href="./lab_parasit/report/export/export_excel_permohonan.php" target="_blank"><font color="#2e2e1f"><i class="fa fa-download fa-fw"></i> Export Excel Semua Data</font></a>
                    ...
                    <a href="?lab=bakteri&page=data_permohonan"><font color="#2e2e1f"><i class="fa fa-arrow-circle-left fa-fw"></i> Ke Lab Bakteri</font></a>
			...
			<div class="judul">
				...
				<i class="fa fa-info-circle fa-fw fa-lg"></i><b><h4><span class="isi">Data Permohonan Pengujian Laboratorium Parasitologi <b>Karantina Hewan</span></b></h4></b>
...
<div class="row" id="sortir">
    ...
    <div class="col-md-1" id="clear" style="margin-top: -6px; z-index: 1">
        <button name="search" id="search_permohonan_kh" class="btn btn-kuprimary"><i class="fa fa-sort"></i> Sortir</button>
    </div>
    <div class="col-md-2"></div>
</div>
...
<div class="row" id="tb">
    ...
    <div class="col-md-12">
      	...
      	<div class="table-responsive">
      		...
      		<table class="table table-hover table-striped" id="tb_permohonan_kh_lab_parasit" width="100%"  style="text-align: center">
...
<div id="content-data_input_permohonan_kh"></div>

<!-- Edit Data -->

<div class="modal fade" id="modal_permohonan_kh" role="dialog">
    <div class="modal-dialog">
        <div id="content-data_permohonan_kh"></div>
    </div>
</div>
      	...
      	<div class="modal-body">
      		...
      		<div class="row">	 
      			...
      			<a class="btn btn-info btn-kembali" data-dismiss="modal"><i class="fa fa-arrow-circle-left fa-fw" aria-hidden="true"></i>Kembali</a>
					...
					<table class="table-responsive table1 table-hover display" id="datapermohonan_kh_lab_parasit" cellspacing="0" width="100%">
						...
						<thead>
							...
							<tr align="center" class="lihat-head">
								...
								<th>Negara/ Area Asal</th>

								<th>Metode Pengambilan Sampel</th>
			...
			<div class="modal-header">
				...
				<div class="modal-body" id="modal-print">
					...
					<div id="responsive-form" class="clearfix">
      					...
      					<form action="./lab_parasit/report/print/print_data_permohonan_multi.php" method="post" target="_blank">
			...
			<div class="modal-header">
				...
				<div class="modal-body" id="modal-print">
					...
					<div id="responsive-form" class="clearfix">
      					...
      					<form action="./lab_parasit/report/export/export_excel_permohonan_bulan.php" method="post" target="_blank">
...
if(@$_GET['act']=='del') {
	...
	$objectDataParasit->hapus($_GET['id']);

	$objectHasilParasit->hapus($_GET['id']);	
	
	header("location: ?lab=parasit&page=data_permohonan");
