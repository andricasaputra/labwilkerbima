...
$othersql = $objectDataParasit->infoPermintaanKesiapanPengujian();
    ...
    $subdata = array();
        ...
        if($kode_sampel == 0 && $penerima == 0){
            ...
            if (strlen($isi) == 0) {
                ...
                <button type="button" id="tombol_input_permintaan_kesiapan_kh" class="btn btn-kusuccess btn-xs" data-toggle="modal" data-target="#modal_input_permintaan_kesiapan_kh" data-id="'.$data2->id.'"><i class="fa fa-plus-circle fa-fw"></i> Input</button>
                ...
                <button type="button" id="tombol_edit_permintaan_kesiapan_kh" class="btn btn-kusuccess btn-xs" data-toggle="modal" data-target="#modal_edit_permintaan_kesiapan_kh" data-id="'.$data2->id.'"><i class="fa fa-edit fa-fw"></i> Edit</button>
                
                <a href="./lab_parasit/report/print/print_permin_pengujian.php?id='.$data2->id.'&no_permohonan='.$data2->no_permohonan.'" target="_blank"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-print fa-fw"></i> Print</button></a>
                ';
            }
            ...
            if(isset($_SESSION['loginsuperkh']) || date("Y-m-d", strtotime($data2->waktu_apdate_sertifikat)) == $objectTanggal->now()){
                ...
                <button type="button" id="tombol_edit_permintaan_kesiapan_kh" class="btn btn-kusuccess btn-xs btn-not-allowed"><i class="fa fa-edit fa-fw"></i> Edit</button>
