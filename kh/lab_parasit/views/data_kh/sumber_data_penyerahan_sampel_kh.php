...
$othersql = $objectDataParasit->infoPenyerahanSampel();
    ...
    $subdata = array();
        ...
        if($tgl == 0 && $penerima == 0){
            ...
            if (strlen($isi) == 0) {
                ...
                <a href="./lab_parasit/report/print/print_penyerahansampel.php?id='.$data2->id.'&no_permohonan='.$data2->no_permohonan.'" target="_blank"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-print fa-fw"></i> Print</button></a>
                ';
            }
