...
$othersql = $objectDataParasit->infoPenunjukanPetugas();
    ...
    $subdata = array();
        ...
        if($data2->kesiapan == 'Tidak'){
            ...
            if (strlen($isi) == 0) {
                ...
                <a href="./lab_parasit/report/print/print_usulan_penunjukan.php?id='.$data2->id.'&no_sampel='.$data2->no_sampel.'" target="_blank"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-print fa-fw"></i> Print</button></a>
                ';
            }
