...
$othersql = $objectDataParasit->infoPenerimaSampel();
    ...
    $subdata = array();
        ...
        if (empty($result_penerima_sampel) && $id2 > $result_id) {
            ...
            if ($isi == 0) {
                ...
                <a href="./lab_parasit/report/print/print_tandaterima_sampel.php?id='.$data2->id.'&no_permohonan='.$data2->no_permohonan.'" target="_blank"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-print fa-fw"></i> Print</button></a>
                ';
            }
