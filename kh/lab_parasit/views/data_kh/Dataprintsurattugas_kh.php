...
<tbody>
  ...
  $tampil = $objectDataParasit->tampil_surat_tugas();
  ...
  <tr>
    ...
    if (strlen($data->no_surat_tugas) !== 0) { ?>
       ...
       <a class="btn btn-kusuccess" href="./lab_parasit/report/print/print_surat_tugas.php?id=<?php echo $data->id?>&no_surat_tugas=<?=$data->no_surat_tugas?> " target="_blank"><i class="fa fa-print fa-fw"></i>Print</a>
