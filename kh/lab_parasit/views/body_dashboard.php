        ...
        <ul class="timeline">
            ...
            <li>
                ...
                <?php 
                    ...
                    $kosong = $objectNomorParasit->Kosongdata();
                    ...
                    if (!empty($isi)) {
                        ...
                        $tampil2 = $objectDataParasit->ambil_id();

                        $result = $tampil2->fetch_object();

                        $isi = $result->id;

                        $tampil = $objectDataParasit->tampil_timeline();
                ...
                <div class="timeline-panel">
                    ...
                    <p><small class="text-muted"><i class="fa fa-time"></i> Laboratorium Karantina Hewan</small></p>
                    ...
                    <div class="timeline-body table-responsive">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td class="isi_bawah"><?php echo $data->nama_sampel ?></td>
                            ...
                            <tr>
                                ...
                                <td class="isi_bawah"><?php echo $data->jumlah_sampel ?> (<?php echo $objectNomor->bilangan($data->jumlah_sampel); ?>)</td>
                            ...
                            <tr>
                                ...
                                <?php if ($data->target_pengujian3 != ''): ?>
                                    
                                    <td class="isi_bawah"><em><?php echo $data->target_pengujian2 ?> & <?php echo $data->target_pengujian3 ?></em></td>

                                <?php else:?>

                                    <td class="isi_bawah"><em><?php echo $data->target_pengujian2 ?></em></td>
                            ...
                            <tr>
                                ...
                                <td class="isi_atas zoom"><a href="?lab=parasit&page=lihat_data_permohonan" class="btn btn-info btn-cirlce"><i class="fa fa-eye fa-fw"></i> Lihat Semua</a></td>
            ...
            <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                    ...
                    <div class="timeline-body table-responsive">
                        ...
                        $tampil = $objectDataParasit->tampil3();

                        $b = $objectDataParasit->tanggal();

                        $c = $objectDataParasit->tanggal_lalu();

                        $d = $objectDataParasit->per_pending();

                        $e = $objectDataParasit->per_selesai();
