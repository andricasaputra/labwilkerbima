...
echo "<tr>";
	...
	echo "<td><i>".$data->target_pengujian3."</i></td>";

	echo "<td>".$data->metode_pengujian."</td>";

	echo "<td><i>".$data->target_pengujian2."</i> : ".$data->positif_negatif."</td>";

	echo "<td><i>".$data->target_pengujian3."</i> : ".$data->positif_negatif_target3."</td>";
