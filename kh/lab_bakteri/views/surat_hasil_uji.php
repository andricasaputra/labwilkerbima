...
<div>
  ...
  <ol class="page-header breadcrumb breadcrumb-fixed">
      ...
      <div id="top">
          ...
          <button type="button" class="btn btn-kuprimary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-th-list fa-fw"></i> Menu <i class="fa fa-caret-down fa-fw"></i></button>
            ...
            <div class="dropdown-menu" style="font-size: 11pt; width: 200px;">
                ...
                <a href="./lab_bakteri/report/export/export_excel_surat_hasil_uji.php" target="_blank"><font color="#2e2e1f"><i class="fa fa-download fa-fw"></i> Export Excel Semua Data</font></a>
                ...
                <li class="divider"></li>
                    ...
                    <a href="?lab=parasit&page=surat_hasil_uji"><font color="#2e2e1f"><i class="fa fa-arrow-circle-left fa-fw"></i> Ke Lab Parasit</font></a>            
      ...
      <div class="judul">
          ...
          <i class="fa fa-info-circle fa-fw fa-lg" aria-hidden="true"></i><b><h4>Data Hasil Pengujian <i>(Laboratorium Bakteriologi)</i></h4></b>
...
<div class="row" id="tb">
  ...
  <div class="col-lg-12">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-hover table-striped" id="tb_lhu_kh"  width="100%"  style="text-align: center">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_bakteri/report/print/print_surat_hasil_uji_multi.php" method="post" target="_blank">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_bakteri/report/export/export_excel_surat_hasil_uji_bulan.php" method="post" target="_blank">
...
<div class="modal-dialog1">
   ...
   <div class="modal-body">
      ...
      <a class="btn btn-info btn-kembali" data-dismiss="modal"><i class="fa fa-arrow-circle-left fa-fw" aria-hidden="true"></i>Kembali</a>
                  ...
                  <table class="table1 table-bordered table-hover" id="datalhu_kh" cellspacing="0" width="100%">
