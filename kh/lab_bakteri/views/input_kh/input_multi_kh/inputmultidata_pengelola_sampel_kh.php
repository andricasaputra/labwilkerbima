              ...
              <div class="modal-body" id="modal-edit">
                ...
                <div id="responsive-form" class="clearfix">
                        ...
                        <div class="column-half">
                          ...
                          <select name="nama_sampel_lab[]" id="nama_sampel_lab_input" class="form-control" style="margin-bottom: 10px">
  ...
  $(document).ready(function(e){
    ...
    $("#form_input_multi_pengelola_sampel_kh").on("submit", (function(e){
         ...
         $.ajax({
           ...
           url :'lab_bakteri/models/input_multi/proses_input_multi_pengelola_sampel_kh.php',
