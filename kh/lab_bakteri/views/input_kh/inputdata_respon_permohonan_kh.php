            ...
            <form id="form_input_respon_permohonan_pengujian_kh">
              ...
              <div class="modal-body" id="modal-edit_kh">
                ...
                <div id="responsive-form" class="clearfix">
                        ...
                        <?php if ($kesiapan == 'Tidak'): ?>

                          <div class="column-full">

                            <b><i style="color: red">Ket : Laboratorium Tidak Siap</i></b><br>
                            <b>Kode Sampel : <?= $kode_sampel; ?></b><br>

                            <div class="column-seperempat">
                              <b>Ketersediaan Penyelia : </b><br>
                            - <?= $penyelia ?> <br>
                            - <?= $penyelia2 ?><br>
                              <b>Ketersediaan Alat :</b><br>
                            - <?= $alat ?> <br>
                            - <?= $alat2 ?> 
                            </div>

                            <div class="column-seperempat">
                              <b>Ketersediaan Analis :</b><br>
                            - <?= $analis ?> <br>
                            - <?= $analis2 ?> <br>
                              <b>Ketersediaan Bahan :</b><br>
                            - <?= $bahan ?> <br>
                            - <?= $bahan2 ?> 
                            </div>
  ...
  $(document).ready(function(e){
      ...
      $("#form_input_respon_permohonan_pengujian_kh").on("submit", (function(e){
           ...
           $.ajax({
             ...
             url :'lab_bakteri/models/proses_input_respon_permohonan_kh.php',
