    ...
    $subdata = array();
       ...
       if($kode_sampel == 0 && $penerima == 0){
            ...
            if (strlen($isi) == 0) {
                ...
                <a href="./lab_bakteri/report/print/print_permin_pengujian.php?id='.$data2->id.'&no_permohonan='.$data2->no_permohonan.'" target="_blank"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-print fa-fw"></i> Print</button></a>
                ';
            }
