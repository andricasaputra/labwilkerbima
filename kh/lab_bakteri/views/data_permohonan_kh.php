			...
			<div class="btn-group " align="left">
			  ...
			  <button type="button" class="btn btn-kuprimary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-th-list fa-fw"></i> Menu <i class="fa fa-caret-down fa-fw"></i></button>
				  ...
				  <div class="dropdown-menu" style="font-size: 11pt; width: 200px;">
				    ...
				    <a href="./lab_bakteri/report/export/export_excel_permohonan.php" target="_blank"><font color="#2e2e1f"><i class="fa fa-download fa-fw"></i> Export Excel Semua Data</font></a>
				    ...
				    <a href="?lab=parasit&page=data_permohonan"><font color="#2e2e1f"><i class="fa fa-arrow-circle-left fa-fw"></i> Ke Lab Parasit</font></a>
...
<div class="row" id="tb">
    ...
    <div class="col-md-12">
      	...
      	<div class="table-responsive">
      		...
      		<table class="table table-hover table-striped" id="tb_permohonan_kh" width="100%"  style="text-align: center">
      	...
      	<div class="modal-body">
      		...
      		<div class="row">	 
      			...
      			<a class="btn btn-info btn-kembali" data-dismiss="modal"><i class="fa fa-arrow-circle-left fa-fw" aria-hidden="true"></i>Kembali</a>
					...
					<table class="table-responsive table1 table-hover display" id="datapermohonan_kh" cellspacing="0" width="100%">
			...
			<div class="modal-header">
				...
				<div class="modal-body" id="modal-print">
					...
					<div id="responsive-form" class="clearfix">
      					...
      					<form action="./lab_bakteri/report/print/print_data_permohonan_multi.php" method="post" target="_blank">
			...
			<div class="modal-header">
				...
				<div class="modal-body" id="modal-print">
					...
					<div id="responsive-form" class="clearfix">
      					...
      					<form action="./lab_bakteri/report/export/export_excel_permohonan_bulan.php" method="post" target="_blank">
...
if(@$_GET['act']=='del') {
	...
	header("location: ?lab=bakteri&page=data_permohonan");
