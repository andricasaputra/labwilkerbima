...
<div>
    <ol class="page-header breadcrumb breadcrumb-fixed">
          ...
          <div class="btn-group " align="left">
            ...
            <button type="button" class="btn btn-kuprimary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-th-list fa-fw"></i> Menu <i class="fa fa-caret-down fa-fw"></i></button>
              ...
              <div class="dropdown-menu" style="font-size: 11pt; width: 200px;">
                   ...
                   <a href="./lab_bakteri/report/export/export_excel_data_teknis.php" target="_blank"><font color="#2e2e1f"><i class="fa fa-download fa-fw"></i> Export Excel Semua Data</font></a>
                  ...
                  <li class="divider"></li>
                    ...
                    <a href="" id="tombol_input_multi_data_teknis"><font color="#2e2e1f"><i class="fa fa-eyedropper" fa-fw></i> Multiple Input</font></a>
                  ...
                  <li class="divider"></li>
                    ...
                    <a href="" data-toggle="modal" data-target="#lembarkerja"><font color="#2e2e1f"><i class="fa fa-list-alt fa-fw"></i> Print Lembar Kerja</font></a>

                  <li class="divider"></li>

                    <a href="?lab=parasit&page=data_teknis"><font color="#2e2e1f"><i class="fa fa-arrow-circle-left fa-fw"></i> Ke Lab Parasit</font></a>
        ...
        <div class="judul">
            ...
            <b><h4>Data Teknis Pengujian <i>(Laboratorium Bakteriologi)</i></h4></b>
...
<div class="row" id="sortir">
    ...
    <div class="col-md-1" id="clear" style="margin-top: -6px; z-index: 1">
        <button name="search" id="search_data_teknis_kh" class="btn btn-kuprimary"><i class="fa fa-sort"></i> Sortir</button>
    </div>
    <div class="col-md-2"></div>
</div>
...
<div class="modal fade" id="modal_input_data_teknis_kh" role="dialog">
    <div class="modal-dialog">
        <div id="content-data_input_data_teknis_kh"></div>
    </div>
</div>

<!-- Input Data Multiple-->

<div class="modal fade" id="modal_input_multi_data_teknis_kh" role="dialog">
    <div class="modal-dialog">
        <div id="content-data_input_multi_data_teknis_kh"></div>
    </div>
</div>

<!-- Edit Data -->

<div class="modal fade" id="modal_edit_data_teknis_kh" role="dialog">
    <div class="modal-dialog">
        <div id="content-data_edit_data_teknis_kh"></div>
    </div>
</div>
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_bakteri/report/print/print_data_teknis_multi.php" method="post" target="_blank">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_bakteri/report/print/print_data_teknis_perhari.php" method="post" target="_blank">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_bakteri/report/print/print_buku_agenda_datek.php" method="post" target="_blank">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_bakteri/report/print/print_buku_harian_datek_kh.php" method="post" target="_blank">
...
<div id="lembarkerja" class="modal fade" role="dialog">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_bakteri/report/print/print_lembar_kerja_datek_kh.php" method="post" target="_blank">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_bakteri/report/export/export_excel_data_teknis_bulan.php" method="post" target="_blank">
...
<div class="modal-dialog1">
   ...
   <div class="modal-body">
      ...
      <a class="btn btn-info btn-kembali" data-dismiss="modal"><i class="fa fa-arrow-circle-left fa-fw" aria-hidden="true"></i>Kembali</a>
                  ...
                  <table class="table1 table-bordered table-hover" id="datateknis_kh" cellspacing="0" width="100%">
