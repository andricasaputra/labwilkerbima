...
<div>
    ...
    <div id="top">
      ...
      <div class="btn-group " align="left">
        ...
        <div class="dropdown-menu" style="font-size: 11pt; width: 200px;">
          ...
          <a href="./report/export/export_excel_pengelola_sampel.php" target="_blank"><font color="#2e2e1f"><i class="fa fa-download fa-fw"></i> Export Excel Semua Data</font></a>
          ...
          <a href="" data-toggle="modal" data-target="#export"><font color="#2e2e1f"><i class="fa fa-cloud-download fa-fw"></i> Export Excel Per Periode</font><a>
            ...
            <a href="" data-toggle="modal" data-target="#draft"><font color="#2e2e1f"><i class="fa fa-pencil fa-fw"></i> Print Draft List Sampel Uji</font></a>
            
            <li class="divider"></li>
            
            <a href="" data-toggle="modal" data-target="#fungsional1"><font color="#2e2e1f"><i class="fa fa-pencil fa-fw"></i> Print Persiapan alat & Bahan</font></a>
            ...
            <a href="?page=fungsional"><font color="#2e2e1f"><i class="fa fa-eye fa-fw"></i>Fungsional</font></a>
      ...
      <div class="judul">
        ...
        <b><h4>Data Distribusi Sampel Pengujian</h4></b>
  ...
  <div class="row" id="sortir">
    ...
    <div class="col-md-1" id="clear" style="margin-top: -6px; z-index: 1">
      <button name="search" id="search_pengelola_sampel" class="btn btn-kuprimary"><i class="fa fa-sort"></i> Sortir</button>
    </div>
    <div class="col-md-2"></div>
  </div>
  ...
  <div class="row" id="tb">
    ...
    <div class="col-lg-12">
      ...
      <div class="table-responsive">
        ...
        <table class="table table-hover table-striped" id="tb_pengelola_sampel" width="100%"  style="text-align: center">
  ...
  <div class="modal fade" id="modal_input_multi_pengelola_sampel" role="dialog">
    <div class="modal-dialog">
      <div id="content-data_input_multi_pengelola_sampel"></div>
    </div>
  </div>
