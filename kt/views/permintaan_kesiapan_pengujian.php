...
<div>
  ...
  <ol class="page-header breadcrumb breadcrumb-fixed">
    ...
    <div id="top">
      ...
      <a id="view_data_permintaan" data-toggle="modal" data-target="#view">
  ...
  <div class="row" id="sortir">
    ...
    <div class="col-md-1" id="clear" style="margin-top: -6px; z-index: 1">
      <button name="search" id="search_permintaan_kesiapan" class="btn btn-kuprimary"><i class="fa fa-sort"></i>  Sortir</button>
    </div>
    <div class="col-md-2"></div>
  </div>
  ...
  <div class="row" id="tb">
    ...
    <div class="col-lg-12">
      ...
      <div class="table-responsive">
        ...
        <table class="table table-hover table-striped" id="tb_permintaan_kesiapan" width="100%"  style="text-align: center">
...
<div class="modal fade" id="modal_input_permintaan_kesiapan" role="dialog">
  <div class="modal-dialog">
    <div id="content-data_input_permintaan_kesiapan"></div>
  </div>
</div>

<!-- Input Data Multiple-->

<div class="modal fade" id="modal_input_multi_permintaan_kesiapan_pengujian" role="dialog">
  <div class="modal-dialog">
    <div id="content-data_input_multi_permintaan_kesiapan_pengujian"></div>
  </div>
</div>

<!-- Edit Data -->

<div class="modal fade" id="modal_edit_permintaan_kesiapan" role="dialog">
  <div class="modal-dialog">
    <div id="content-data_edit_permintaan_kesiapan"></div>
  </div>
</div>
...
<div id="view" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog1">
    ...
    <div class="modal-body">
      ...
      <div class="row" id="Showdataperminkesiapanpengujian">
        ...
        <table class="table1 table-hover" id="dataperminkesiapan" cellspacing="0" width="100%">
