...
$sql = "SELECT * FROM input_permohonan WHERE NOT (metode_pengujian = 'Identifikasi Morfologi') AND bagian_tumbuhan IN ('Biji/Benih', 'Buah') AND ";
...
while($data2 = $query->fetch_object()){
    ...
    $subdata = array();
        ...
        if($tgl == 0){
            ...
            if ($data2->nama_patogen == 'Cendawan' || $data2->nama_patogen == 'Bakteri') {
                

                if ($data2->bagian_tumbuhan == 'Buah' || $data2->bagian_tumbuhan == 'Biji/Benih') {

                     $subdata[] = '

                    <a href="#"><button type="button" class="btn btn-danger btn-xs btn-not-allowed" disabled><i class="fa fa-print fa-fw"></i> Benih</button></a>
                    ';
                 ...
                 if ($data2->nama_patogen == 'Cendawan' || $data2->nama_patogen == 'Bakteri') {
                    ...
                    if ($data2->bagian_tumbuhan == 'Buah' || $data2->bagian_tumbuhan == 'Biji/Benih') {
                            ...
                            $subdata[] = '
                              ...
                              <a href="./report/fungsional/penyemaian_benih.php?id='.$data2->id.'&no_permohonan='.$data2->no_permohonan.'" target="_blank"><button type="button" class="btn btn-danger btn-xs"><i class="fa fa-print fa-fw"></i> Benih</button></a>
                            ';
