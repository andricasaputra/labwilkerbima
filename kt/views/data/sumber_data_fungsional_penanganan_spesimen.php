...
while($data2 = $query->fetch_object()){
    ...
    $subdata = array();
        ...
        if($tgl == 0){
                    ...
                    <a href="#"><button type="button" class="btn btn-kusuccess btn-xs btn-not-allowed" disabled><i class="fa fa-print fa-fw"></i> Penanganan Spesimen</button></a>
            ...
            if (strlen($isi) == 0) {
                            ...
                            $subdata[] = '
                              ...
                              <a href="./report/fungsional/print_penanganan_spesimen.php?id='.$data2->id.'&no_permohonan='.$data2->no_permohonan.'&tanggal_pengujian='.$data2->tanggal_pengujian.'" target="_blank"><button type="button" class="btn btn-kusuccess btn-xs"><i class="fa fa-print fa-fw"></i> Penanganan Spesimen</button></a>
