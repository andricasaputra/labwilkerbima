...
$othersql = $objectData->infoPengelolaSampel();
...
while($data2 = $query->fetch_object()){
    ...
    $subdata = array();
        ...
        if($data2->kesiapan == 'Tidak'){
        ...
        }elseif (empty($result_yang_menerimalab) && $id2 > $result_id) {
            ...
            if (strlen($isi) == 0) {
                ...
                <button type="button" id="tombol_input_pengelola_sampel" class="btn btn-kusuccess btn-xs" data-toggle="modal" data-target="#modal_input_pengelola_sampel" data-id="'.$data2->id.'"><i class="fa fa-plus-circle fa-fw"></i> Input</button>
                ...
                <button type="button" id="tombol_edit_pengelola_sampel" class="btn btn-kusuccess btn-xs" data-toggle="modal" data-target="#modal_edit_pengelola_sampel" data-id="'.$data2->id.'"><i class="fa fa-edit fa-fw"></i> Edit</button>
                
                <a href="./report/print/print_distribusi_sampel.php?id='.$data2->id.'&no_permohonan='.$data2->no_permohonan.'" target="_blank"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-print fa-fw"></i> Print</button></a>
                ';
            }
            ...
            if(isset($_SESSION['loginsuperkt']) || date("Y-m-d", strtotime($data2->waktu_apdate_sertifikat)) == $objectTanggal->now()){
                ...
                <button type="button" id="tombol_edit_pengelola_sampel" class="btn btn-kusuccess btn-xs btn-not-allowed"><i class="fa fa-edit fa-fw"></i> Edit</button>
