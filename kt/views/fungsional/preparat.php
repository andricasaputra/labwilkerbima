...
<div>
    ...
    <ol class="page-header breadcrumb breadcrumb-fixed">
        ...
        <div id="top">
            ...
            <a href="./report/fungsional/export_excel_pembuatan_preparat.php" class="btn btn-kuprimary" target="_blank"><font color="#fff"><i class="fa fa-download fa-fw"></i> Export Excel Preparat</font></a>
        ...
        <div class="judul">
            ...
            <b><h4>Halaman Pembuatan Preparat</h4></b>
...
<div class="row" id="sortir">
    ...
    <div class="col-md-1" id="clear" style="margin-top: -6px; z-index: 1">
        <button name="search" id="search_fungsional_pembuatan_preparat" class="btn btn-kuprimary"><i class="fa fa-sort"></i> Sortir</button>
    </div>
 ...
 <div class="row" id="tb">
  ...
  <div class="col-lg-12">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-hover table-striped" id="tb_fungsional_pembuatan_preparat" width="100%"  style="text-align: center">
