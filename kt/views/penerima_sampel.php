...
<div>
  ...
  <ol class="page-header breadcrumb breadcrumb-fixed">
    ...
    <div id="top">
      ...
      <a id="view_data_penerima" data-toggle="modal" data-target="#view">
      ...
      <div class="btn-group " align="left">
        ...
        <div class="dropdown-menu" style="font-size: 11pt; width: 200px;">
          ...
          <a href="./report/export/export_excel_tandaterima_sampel.php" target="_blank"><font color="#2e2e1f"><i class="fa fa-download fa-fw"></i> Export Excel Semua Data</font></a>
        ...
        <div class="judul">
          ...
          <i class="fa fa-info-circle fa-fw fa-lg" aria-hidden="true"></i><b><h4>Data Penerimaan Sampel Pengujian</h4></b>
    ...
    <div class="row" id="sortir">
      ...
      <div class="col-md-1" id="clear" style="margin-top: -6px; z-index: 1">
        <button name="search" id="search_penerima_sampel" class="btn btn-kuprimary"><i class="fa fa-sort"></i>  Sortir</button>
      </div>
      <div class="col-md-2"></div>
    </div>
    ...
    <div class="row" id="tb">
      ...
      <div class="col-lg-12">
        ...
        <div class="table-responsive">
          ...
          <table class="table table-hover table-striped" id="tb_penerima_sampel" width="100%"  style="text-align: center">
    ...
    <div class="modal fade" id="modal_input_multi_penerima_sampel" role="dialog">
      <div class="modal-dialog">
        <div id="content-data_input_multi_penerima_sampel"></div>
      </div>
    </div>
    
    <!-- Edit Data -->
    
    <div class="modal fade" id="modal_edit_penerima_sampel" role="dialog">
      <div class="modal-dialog">
        <div id="content-data_edit_penerima_sampel"></div>
      </div>
    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" id="modal-print">
            ...
            <div id="responsive-form" class="clearfix">
              ...
              <form action="./report/print/print_tandaterima_sampel_multi.php" method="post" target="_blank">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" id="modal-print">
            ...
            <div id="responsive-form" class="clearfix">
              ...
              <form action="./report/export/export_excel_tandaterima_sampel_bulan.php" method="post" target="_blank">
    ...
    <div id="view" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      ...
      <div class="modal-dialog1">
        ...
        <div class="modal-body">
          ...
          <div class="row" id="Showdatatandaterima">
            ...
            <table class="table1 table-hover datatables6" id="datapenerimasampel" cellspacing="0" width="100%">
