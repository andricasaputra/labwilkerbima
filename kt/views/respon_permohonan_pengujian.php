<div>
  ...
  <ol class="page-header breadcrumb breadcrumb-fixed">
    ...
    <div id="top">
      ...
      <a id="view_data_respon" data-toggle="modal" data-target="#lihat">
      ...
      <div class="btn-group " align="left">
        ...
        <div class="dropdown-menu" style="font-size: 11pt; width: 200px;">
          ...
          <a href="./report/export/export_excel_respon_permohonan_pengujian.php" target="_blank"><font color="#2e2e1f"><i class="fa fa-download fa-fw"></i> Export Excel Semua Data</font></a>
      ...
      <div class="judul">
        ...
        <i class="fa fa-info-circle fa-fw fa-lg" aria-hidden="true"></i><b><h4>Respon Permohonan Pengujian</h4></b>
  ...
  <div class="row" id="sortir">
    ...
    <div class="col-md-1" id="clear" style="margin-top: -6px; z-index: 1">
      <button name="search" id="search_respon_permohonan" class="btn btn-kuprimary"><i class="fa fa-sort"></i> Sortir</button>
    </div>
    <div class="col-md-2"></div>
  </div>
  ...
  <div class="row" id="tb">
    ...
    <div class="col-lg-12">
      ...
      <div class="table-responsive">
        ...
        <table class="table table-hover table-striped" id="tb_respon_permohonan" width="100%"  style="text-align: center">
  ...
  <div class="modal fade" id="modal_input_respon_permohonan" role="dialog">
    <div class="modal-dialog">
      <div id="content-data_input_respon_permohonan"></div>
    </div>
  </div>
  
  <!-- Input Data Multiple-->
  
  <div class="modal fade" id="modal_input_multi_respon_permohonan" role="dialog">
    <div class="modal-dialog">
      <div id="content-data_input_multi_respon_permohonan"></div>
    </div>
  </div>
  
  <!-- Edit Data -->
  
  <div class="modal fade" id="modal_edit_respon_permohonan" role="dialog">
    <div class="modal-dialog">
      <div id="content-data_edit_respon_permohonan"></div>
    </div>
  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
            ...
            <form action="./report/print/print_respon_permohonan_pengujian_multi.php" method="post" target="_blank">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
            ...
            <form action="./report/export/export_excel_respon_permohonan_pengujian_bulan.php" method="post" target="_blank">
  ...
  <div id="lihat" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog1">
      ...
      <div class="modal-body">
        ...
        <div class="row" id="Showdatarespon">
          ...
          <table class="table1 table-hover" id="datarespon" cellspacing="0" width="100%">
