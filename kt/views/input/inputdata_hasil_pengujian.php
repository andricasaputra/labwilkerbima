                  ...
                  <div id="responsive-form" class="clearfix">
                      ...
                      <div class="column-half">
                        ...
                        <input type="text" class="form-control" name="tanggal_penyerahan_lab" id="tanggal_penyerahan_lab_input" value="<?=$tgl_indo?>" disabled>
                         ...
                         <input type="hidden" class="form-control" name="tanggal_sertifikat" id="tanggal_sertifikat_input" value="<?=$tgl_indo?>">
                      ...
                      <div class="column-half">
                        ...
                        <input type="text" class="form-control" name="tanggal_sertifikat" id="tanggal_sertifikat_input" value="<?=$tanggal_sertifikat?>">
                          ...
                          <?php 
                            ...
                            $setno = $objectNomor->set_maxnoSer();
                            while ($ambil = $setno->fetch_object()) {
                                $hasil = $ambil->Maxid;
                            }
                            ...
                            if (!empty($isi)) {
                                ...
                                $maxNo = $objectNomor->max_noSer($hasil);
                                ...
                                $maxnomor = $objectNomor->max_nomorSer(@$isiNo);

                                $isi2 = $maxnomor->fetch_object();

                                $isiNomor = (int)$isi2->no_sertifikat + 1;
  ...
  $(document).ready(function(e){
    ...
    $("#form_input_hasil_pengujian").on("submit", (function(e){
         ...
         $.ajax({
           ...
           url :'models/proses_input_hasil_pengujian.php',
