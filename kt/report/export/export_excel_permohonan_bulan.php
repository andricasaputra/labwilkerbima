...
$fileName = "Data_Permohonan-(". $tanggal.'-'.$bln.'-'.$thn. ' s/d ' .$tanggalb.'-'.$blnb.'-'.$thnb. ").xls";
...
<div>
	...
	<center><h3>DATA PERMOHONAN PENGUJIAN LABORATORIUM KARANTINA TUMBUHAN</h3>
	...
	<table border="1px">
					...
					if(@$_POST['export_data']){
						...
						$tampil = $objectData->objectPrint(@$_POST['tgl_a'], @$_POST['tgl_b']);
