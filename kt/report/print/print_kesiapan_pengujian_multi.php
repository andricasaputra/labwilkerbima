        ...
        $content .='
           ...
           <tr>
                ...
                if ($data->bahan == 'Baik') { 
                    ...
                    <td  style="; padding-left: -100px">Baik<span style="margin-left:53px"><img src="'.$checkfix.'" style="width: 15px"></span><span style="margin-left:15px">Kadaluarsa</span><span style="margin-left:43px"><img src="'.$boxfix.'" style="width: 15px"></span></td>
                ...
                <td  style="; padding-left: -100px">Baik<span style="margin-left:53px"><img src="'.$boxfix.'" style="width: 15px"></span><span style="margin-left:15px">Kadaluarsa</span><span style="margin-left:43px"><img src="'.$checkfix.'" style="width: 15px"></span></td>
