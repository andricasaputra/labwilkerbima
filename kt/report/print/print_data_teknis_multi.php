                        ...
                        $content .='
                            ...
                            <tr>
                                ...
                                ';
                                    ...
                                    if ($data2->tanggal_pengujian == $objectTanggal->tgl_indo(date(substr($data2->waktu_input_hasil, 0, 10)))) {  
                                        ...
                                        <td width="250">'.$data2->tanggal_pengujian.' - '.$objectTanggal->tgl_indo(date(substr($data2->waktu_input_hasil, 0, 10))).'</td>
